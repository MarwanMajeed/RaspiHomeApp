 ...
 * @author rossmann
 */
public class Wohnzimmer extends javax.swing.JFrame {

RSHomatic RSH;
    /**
     * Creates new form Wohnzimmer
     */
    public Wohnzimmer() {
        initComponents();
        RSH = new RSHomatic();
        String s = RSH.GetValue(1859);
        if (s.endsWith("true")) {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Birne Aus.png"))); // NOI18N
        jToggleButton1.setText("A1");
        jToggleButton1.setFocusPainted(false);
        jToggleButton1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jToggleButton1.setName("Schalter_A1"); // NOI18N
        jToggleButton1.setRolloverEnabled(false);
        jToggleButton1.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Birne Ein.png"))); // NOI18N
    ...
    private void jToggleButton1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jToggleButton1StateChanged
        ...
        if (selected== true) {
            RSH.SetVar(1859,"true");
        }else{
            RSH.SetVar(1859,"false");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Wohnzimmer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Wohnzimmer().setVisible(true);
            }
        });
    }
